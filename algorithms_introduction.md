...
Абстрактный тип данных -- это формальное описание. Структура данных -- это
указание, в каком виде хранить эти данные и как получать к ним доступ.
Алгоритм удобно формулировать в абстрактных терминах, то есть не конкретизируя
способ представления объектов АТД.
