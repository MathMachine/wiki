...
{% raw %}
$$
f'(x_k) = f'(x_*) + f''(x_*)(x_k - x_*) + \frac{1}{2}f'''(x_*)(x_k - x_*)^2 + \ldots + \frac{1}{(p-1)!}f{(p)}(\xi_k^{(2)})(x_k - x_*)^{p-1} =
$$
$$
...
{% raw %}
$$\|G(x_* + d^k) - G(x_*) - G'(x^k)d^k\|_Y = \|G(x_* + d^k) - G(x_*) - G'(x_* + d^k)d^k\|_Y \leq$$
$$\leq \|G(x_* + d^k) - G(x_*) - G'(x_*)d^k\|_Y + \leq \|(G'(x_*) - G'(x_* + d^k))d^k\|_Y \leq$$
